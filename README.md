...
```json
{
  ...
  "generatedAt": "2026-06-18T23:47:06.741Z",
  "endpoints": [
    {
      "method": "GET",
      "path": "/",
    ...
    },
    {
      ...
      "path": "/notify",
      "worker": "atlas-notify",
      "description": "Deliver an event into the Discord pipeline (auth required)"
    },
    {
      "method": "GET",
      "path": "/notify/health",
    ...
    },
    {
      ...
      "worker": "deploy-watch",
      "description": "Latest Cloudflare Pages deploy snapshot (used by homepage)"
    },
    {
      "method": "GET",
  ...
  "repos": {
    "atlas-notify": "[https://github.com/AtlasReaper311/atlas-notify](https://github.com/AtlasReaper311/atlas-notify)",
    "github-pulse": "[https://github.com/AtlasReaper311/github-pulse](https://github.com/AtlasReaper311/github-pulse)",
    "site-pulse": "[https://github.com/AtlasReaper311/site-pulse](https://github.com/AtlasReaper311/site-pulse)",
    "deploy-watch": "[https://github.com/AtlasReaper311/deploy-watch](https://github.com/AtlasReaper311/deploy-watch)"
  }
}
---
